...
MegaRise is built upon the fundamentals of Buyback and increasing the investor's value
...
contract HugeDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf02416268090CBE5f58be3ff906a311cEe70D484); // Marketing Address
    ...
    string private _name = "HugeDog";
    string private _symbol = "HugeDog";
